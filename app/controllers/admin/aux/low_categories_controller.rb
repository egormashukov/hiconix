class Admin::Aux::LowCategoriesController < Admin::Aux::ApplicationController
  ...
  def togglevisible
    ...
    @low_category.save
    render 'admin/aux/low_categories/togglevisible.js.coffee'
  end
  ...
  def low_category_scope
    # LowCategory.order(:position)
    CatalogueBrandLink.aux_brand_link.try(:low_categories)
  end
